      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4 py-12 pb-32">
        <div className="max-w-xl w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <div className="flex flex-col items-center mb-8">
            <div className="w-16 h-16 mb-4 bg-white rounded-full flex items-center justify-center border border-green-200 overflow-hidden shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input required type="tel" value={formData.mobile} onChange={(e) => setFormData({...formData, mobile: e.target.value})} className="w-full px-4 py-2 border rounded-lg focus:ring-green-500 outline-none" />
            </div>
